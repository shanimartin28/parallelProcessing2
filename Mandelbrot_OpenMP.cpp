...
/*
  This program provides a openmp implementation that generates Mandelbrot fractals. 
*/
...
int plotImageFile()
{
  ...
  FILE * fp;
  char *filename="mandelbrot_omp.ppm";
  char *comment="# ";
...
main(int argc, char *argv[])
{
    ...
    printf("Mandelbrot OpenMP Time Difference:%f\n",time_diff);
